...
export function sumArrayWithThreeNumbers(sumArr) {
    return [
        ...
        `${sumArr} was passed in as an array of numbers, and ${sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0]} is their sum.`
    ];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    return [
        ...
        `The numbers ${multArr} have a product of ${multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0]}.`,
    ];
}
